function makeTextSprite( message, parameters )
{
	...
	var fontColor = parameters.hasOwnProperty("fontColor") ?
		parameters["fontColor"] : { r:200, g:200, b:255, a:1.0 };
	...
	roundRect(context, borderThickness/2, borderThickness/2, textWidth + borderThickness, fontsize * 1.4 + borderThickness + 10, 15);
