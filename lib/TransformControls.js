...
(function () {
		...
		this.init = function () {
			...
			this.traverse(function ( child ) {
				if (child instanceof THREE.Mesh) {
					...
					THREE.GeometryUtils.merge( child.geometry, tempGeometry);
	...
	THREE.TransformGizmoTranslate = function () {
		...
		THREE.GeometryUtils.merge( mesh.geometry, arrowGeometry);
	...
	THREE.TransformControls = function ( camera, domElement ) {
		...
		window.addEventListener( 'keydown', _bind(this, this.onKeyPress) );
	};
