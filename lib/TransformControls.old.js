...
(function () {
	...
	THREE.TransformControls = function ( camera, domElement ) {
		...
		this.onKeyPressCallBack = _bind(this, this.onKeyPress);
		 
		this.destroy = function() {
			window.removeEventListener("keydown", this.onKeyPressCallBack, false);	
		...
		window.addEventListener( 'keydown', this.onKeyPressCallBack );
	};
